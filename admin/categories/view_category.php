...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    if($qry->num_rows > 0){
		...
		echo '<script>alert("category ID is not valid."); location.replace("./?page=categorys")</script>';
	}
}else{
	echo '<script>alert("category ID is Required."); location.replace("./?page=categorys")</script>';
}
?>
<style>
