...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=products/manage_product" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
					...
					?>
						<tr>
							...
							<td class="text-center">
								<img src="<?= validate_image($row['thumbnail_path']) ?>" alt="" class="img-tubmbnail p-0 border border-dark rounded-0 product-thumbnail">
							</td>
